            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('priority') is-invalid @enderror" id="priority" name="priority" value="{{ $task->priority }}">
                        @error('priority')
                            <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <select type="project"class="form-control input-lg  @error('project_id') is-invalid @enderror" id="project" name="project_id">
